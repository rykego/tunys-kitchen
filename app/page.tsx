...
// ── CONFIGURATION (From your original index.html) ──
const CONFIG = {
  businessName: "Tuny's Kitchen",
  paynowNumber: "+65 9785 0256",
  whatsappNumber: "6585028158",
};
...
const MENU = {
  ...
  drinks: [
    { id:'d1', name:'Teh Tarik', emoji:'🍵', price:2.00,  desc:'Creamy pulled tea, hot or iced.' },
    { id:'d3', name:'Calamansi Juice', emoji:'🍋', price:2.50,  desc:'Freshly squeezed calamansi.' },
  ]
};
